        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cash-sessions.index')" :active="request()->routeIs('cash-sessions.*')">
                        {{ __('Caja del día') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('sales.scanner')" :active="request()->routeIs('sales.scanner*')">
                        {{ __('Ventas escáner') }}
                    </x-nav-link>
